...
function IngredientForm({validation,Ingredients, setIngredient,Category, setCategory}) {
          ...
          <Row className="mt-3 mb-3" key={element.componentId}>
            <Col>
              ...
              <CreatableSelect isClearable
                ...
                styles={validation===true&&element.name===""?customStylesVALIDATE:customStylesStandard}
                require
              />
            ...
            <Col>
              <InputGroup>
                ...
                <Form.Control
                  placeholder="unit"
                  type="text"
                  onChange={(e)=>UnitNameUpdate(element.componentId,e.target.value)}
                  value={element.value}
                  pattern="[a-zA-Z]+"
                  required
                />
